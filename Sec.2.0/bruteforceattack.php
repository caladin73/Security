...
php bruteforce.php -- localhost Security/Sec.1.1/login0Auth_bruteforce_attack_secure.php darkuids.txt darkpwds.txt darkresults.txt

old uden beskyttelse mod bruteforce:
php bruteforce_hash.php -- localhost Security/Sec.1.1/login0Auth.php darkuids.txt darkpwds.txt darkresults.txt
...
php bruteforce.php -- web2.pete334y.iba-abakomp.dk /Yadda/model/Authentication.inc.php darkuids.txt darkpwds.txt darkresults.txt
